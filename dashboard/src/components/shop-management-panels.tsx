...
type Report = { metrics?: { grossSalesMinor?: number; discountsMinor?: number; shippingMinor?: number; refundsMinor?: number | null; netSalesMinor?: number; orders?: number }; topProducts?: { name: string; units: number; revenueMinor: number }[] };
